...
to generate recipe steps, that apply custom transformations to a data set. 
...
* `prep_output`: the output from `prep` helper function containing 
...
Let us see the function in action. My first (sanity) check of the function is to
